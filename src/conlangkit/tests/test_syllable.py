...
def test_constrained_pattern_matches():
    ...
    def expect(pat, text, true_or_false):
        assert_match(pat, text, true_or_false, inventory)
...
def assert_syl(
    vowels, consonants, pats, min_count=0, max_count=NO_MAX, must_include=None, cant_include=None
):
    n = 0
    cant = []
    s = []
